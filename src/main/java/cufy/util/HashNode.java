...
//		 * @since 0.0.1 ~2021.04.18
//		 */
//		public HashLink(@NotNull Node.Key key, @NotNull Node<V> node) {
//			Objects.requireNonNull(key, "key");
//			Objects.requireNonNull(node, "node");
//			this.key = key;
//			this.opposite = new HashLink<>(key.opposite(), this);
//			this.node = node;
//		}
//
//		/**
...
//		 * @param key      the key of the constructed link.
//		 * @param node     the initial node of the constructed link.
//		 * @param opposite the initial node of the opposite link of the constructed link.
//		 * @throws NullPointerException if the given {@code key} or {@code node} or {@code
//		 *                              opposite} is null.
//		 * @since 0.0.1 ~2021.04.18
//		 */
//		public HashLink(@NotNull Node.Key key, @NotNull Node<V> node, @NotNull Node<V> opposite) {
//			Objects.requireNonNull(key, "key");
//			Objects.requireNonNull(node, "node");
//			Objects.requireNonNull(opposite, "opposite");
//			this.key = key;
//			this.opposite = new HashLink<>(key.opposite(), this, opposite);
//			this.node = node;
//		}
//
//		/**
...
//		 * @param node     the initial node of the constructed link.
//		 * @throws NullPointerException if the given {@code key} or {@code opposite} or
//		 *                              {@code node} is null.
//		 * @since 0.0.1 ~2021.04.18
//		 */
//		protected HashLink(@Nullable Node.Key key, @NotNull Node.Link<V> opposite, @NotNull Node<V> node) {
//			Objects.requireNonNull(key, "key");
//			Objects.requireNonNull(opposite, "opposite");
//			Objects.requireNonNull(node, "node");
//			this.key = key;
