...
/*
	//These are methods that could be added without
	//breaking the design. But, have not been added
	//because of either the implementation issues or
	//their dangerous behaviour. Such as encouraging
	//programmers to use nodes as storage containers
	//witch is not their duty.
	...
	//Map methods with respect to Link
	void putAll(Set<Link>)
	//Link<K, V> getOrDefault(K, Link<K, V>)
	void forEach(Consumer<Link<K, V>)
	void replaceAll(Function<Link<K, V>, Link<K, V>>)
	Link<K, V> putIfAbsent(K, Link<K, V>)
	boolean remove(K, Link<K, V>)
	boolean replace(K, Link<K, V>, Link<K, V>)
	Link<K, V> replace(K, Link<K, V>)
	Link<K, V> computeIfAbsent(K, Function<K, Link<K, V>)
	Link<K, V> computeIfPresent(K, BiFunction<K, Link<K, V>, Link<K, V>>)
	Link<K, V> compute(K, BiFunction<K, Link<K, V>, Link<K, V>>)
	Link<K, V> merge(K, Link<K, V>, BinaryOperator<Link<K, V>>)

	+ Node<K, V> put(K, Node<K, V>)
	//void putAll(Set<Node<K, V>>)
	//Node<K, V> getOrDefault(K, Node<K, V>)
	void forEach(BiConsumer<K, Node<K, V>>)
	void replaceAll(BiFunction<K, Node<K, V>, Node<K, V>>)
	+ Node<K, V> putIfAbsent(K, Node<K, V>)
	+ boolean remove(K, Node<K, V>)
	+ boolean replace(K, Node<K, V>, Node<K, V>)
	+ Node<K, V> replace(K, Node<K, V>)
	//Node<K, V> computeIfAbsent(K, Function<K, Node<K, V>>)
	//Node<K, V> computeIfPresent(K, BiFunction<K, Node<K, V>, Node<K, V>>)
	//Node<K, V> compute(K, BiFunction<K, Node<K, V>, Node<K, V>>)
	//Node<K, V> merge(K, Node<K, V>, BinaryOperator<Node<K, V>>)
*/
//
//	/**
//	 * Set the value of this node to the result of invoking the given {@code operator}
//	 * with the argument being the current value set to this node.
//	 * <br>
//	 * Exceptions thrown by the given {@code operator} will fall throw this method.
//	 *
//	 * @param operator the computer operator.
//	 * @return the value of this node after invoking this method.
//	 * @throws NullPointerException          if the given {@code operator} is null; if the
//	 *                                       value returned from the given {@code
//	 *                                       operator} is null and this node does not
//	 *                                       support null value.
//	 * @throws IllegalArgumentException      if this node rejected the value returned from
//	 *                                       the given {@code operator}.
//	 * @throws ClassCastException            if the value returned from the given {@code
//	 *                                       operator} is of an inappropriate type for
//	 *                                       this node.
//	 * @throws UnsupportedOperationException if this node refused to change its value.
//	 * @since 0.0.1 ~2021.04.22
//	 */
//	@Nullable
//	@Contract(mutates = "this")
//	default V compute(@NotNull UnaryOperator<V> operator) {
//		Objects.requireNonNull(operator, "operator");
//		V v = this.get();
//		V value = operator.apply(v);
//		this.set(value);
//		return value;
//	}
//
//	/**
//	 * If the value of this is currently set to {@code null}. Then, set the value of this
//	 * to be the results of invoking the given {@code supplier}.
//	 * <br>
//	 * Exceptions thrown by the given {@code supplier} will fall throw this method.
//	 *
//	 * @param supplier the computing supplier.
//	 * @return the value of this node after invoking this method.
//	 * @throws NullPointerException          if the given {@code supplier} is null; if the
//	 *                                       value returned from the given {@code
//	 *                                       supplier} is null and this node does not
//	 *                                       support null value.
//	 * @throws IllegalArgumentException      if this node rejected the value returned from
//	 *                                       the given {@code supplier}.
//	 * @throws ClassCastException            if the value returned from the given {@code
//	 *                                       supplier} is of an inappropriate type for
//	 *                                       this node.
//	 * @throws UnsupportedOperationException if this node refused to change its value.
//	 * @since 0.0.1 ~2021.04.22
//	 */
//	@Nullable
//	@Contract(mutates = "this")
//	default V computeIfAbsent(@NotNull Supplier<V> supplier) {
...
//
//	/**
//	 * If the value of this is currently set to {@code non-null}. Then, set the value of
//	 * this node to the result of invoking the given {@code operator} with the argument
//	 * being the current value set to this node.
//	 * <br>
//	 * Exceptions thrown by the given {@code operator} will fall throw this method.
//	 *
//	 * @param operator the computer operator.
...
//	@Nullable
//	@Contract(mutates = "this")
//	default V computeIfPresent(@NotNull UnaryOperator<V> operator) {
//		Objects.requireNonNull(operator, "operator");
//		V v = this.get();
//		if (v != null) {
//			V value = operator.apply(v);
...
//
//	/**
//	 * If there is no node mapped to the given {@code key} in this node. Then map the
//	 * given {@code node} to the given {@code key}.
//	 * <br><br>
//	 * Basic Implementation:
//	 * <pre>
//	 *     Node<V> n = this.getNode(key);
//	 *     if (n == null)
//	 *          this.putNode(key, node);
//	 *     return n;
//	 * </pre>
//	 *
//	 * @param key  the key to map the given {@code node}.
//	 * @param node the node to be mapped.
//	 * @return the previous node associated to the given {@code key}. Or {@code null} if
//	 * 		there was none.
//	 * @throws NullPointerException          if the given {@code key} or {@code node} is
//	 *                                       null.
//	 * @throws IllegalArgumentException      if this node rejected the given {@code key};
//	 *                                       if the given {@code node} rejected the link
//	 *                                       created by this node; if the given {@code
//	 *                                       node} rejected the given {@code key}.
//	 * @throws UnsupportedOperationException if this node refused to have a link with the
//	 *                                       given {@code key}; if the given {@code node}
//	 *                                       refused to have a link with the opposite of
//	 *                                       the given {@code key}.
//	 * @since 0.0.1 ~2021.04.22
//	 */
//	@Nullable
//	@Contract(mutates = "this,param2")
//	default Node<V> putNodeIfAbsent(@NotNull Key key, @NotNull Node<V> node) {
...
//	default boolean removeNode(Key key, Node<V> node) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(node, "node");
//		Node<V> n = this.getNode(key);
//		if (n == node) {
...
//	default boolean replaceNode(Key key, Node<V> oldNode, Node<V> newNode) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(oldNode, "oldNode");
//		Objects.requireNonNull(newNode, "newNode");
//		Node<V> n = this.getNode(key);
//		if (n == oldNode) {
//			this.putNode(key, newNode);
//			return true;
//		}
//		return false;
//	}
...
//	@Nullable
//	@Contract(mutates = "this,param2")
//	default Node<V> replaceNode(Key key, Node<V> node) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(node, "node");
//		Node<V> n = this.getNode(key);
//		if (n != null)
...
//	@Nullable
//	@Contract(mutates = "this")
//	default Node<V> computeNode(Key key, BiFunction<Key, Node<V>, Node<V>> function) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(function, "function");
//		Node<V> n = this.getNode(key);
//		Node<V> node = function.apply(key, n);
//		if (node == null)
//			this.removeKey(key);
//		else
//			this.putNode(key, node);
...
//	@Nullable
//	@Contract(mutates = "this")
//	default Node<V> computeNodeIfAbsent(Key key, Function<Key, Node<V>> function) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(function, "function");
//		Node<V> n = this.getNode(key);
//		if (n == null) {
//			Node<V> node = function.apply(key);
//			if (node != null)
//				this.putNode(key, node);
//			return node;
//		}
...
//	@Nullable
//	@Contract(mutates = "this")
//	default Node<V> computeNodeIfPresent(Key key, BiFunction<Key, Node<V>, Node<V>> function) {
//		Objects.requireNonNull(key, "key");
//		Objects.requireNonNull(function, "function");
//		Node<V> n = this.getNode(key);
//		if (n != null) {
...
OTHER VALUES -----------------------------------------------------------------------
	/**
	 * Return the value of the node relating to this node with the given {@code key}.
	 *
	 * @param key the key of the relation between this node and the node its value to be
	 *            returned.
	 * @return the value of the node relating to this node with the given {@code key}. Or
	 *        {@code null} if this node has no node relating to it with the given {@code key}.
	 *        {@code null} also might indicate that the node has its value set to {@code
	 * 		null}.
	 * @throws NullPointerException if this node does not support null keys.
	 * @throws ClassCastException   if the given {@code key} is of an inappropriate type
	 *                              for this node.
	 * @since 0.0.1 ~2021.04.22
	 * /
	@Nullable
	@Contract(pure = true)
	default V getValue(@Nullable K key) {
		Link<K, V> link = this.getLink(key);
		return link == null ? null : link.getValue();
	}

	default V getValue(@Nullable Node.Key<K> key) {
		Objects.requireNonNull(key, "key");
		Link<K, V> link = this.getLink(key);
		return link == null ? null : link.getValue();
	}
INTERFACES -------------------------------------------------------------------------
	...
	/**
	 * A keys holder for nodes to know a key and its opposite.
	 *
